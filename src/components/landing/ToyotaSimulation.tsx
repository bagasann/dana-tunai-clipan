                        ...
                        <div key={index} className="group bg-white/5 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/10 hover:border-blue-400/30 hover:shadow-[0_0_60px_rgba(30,58,138,0.4)] transition-all duration-500 flex flex-col relative focus-within:ring-2 focus-within:ring-blue-500">
                            ...
                            <div className="relative aspect-[3/4.8] overflow-hidden bg-black/40">
                                <img
                                    src={item.image}
                                    alt={item.alt}
                                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-1000 block"
                                />
                            </div>
                            ...
                            <div className="p-6 pt-6 relative z-20">
                                ...
                                >
                                    <Button
                                        variant="cta"
                                        className="w-full py-7 text-lg h-auto bg-blue-600 hover:bg-blue-500 shadow-[0_10px_30px_rgba(37,99,235,0.3)] hover:shadow-[0_15px_40px_rgba(37,99,235,0.5)] transition-all flex items-center justify-center gap-3 rounded-2xl"
                                    >
                                        <WhatsAppIcon />
...
Terima kasih`)}`}
                ...
                <div className="mt-16 text-center text-[10px] font-bold text-white/20 uppercase tracking-[0.3em]">
                    Proses Mudah, Aman, dan Terpercaya. Segera hubungi tim kami untuk konsultasi gratis.
                </div>
            </div>
        </div>
    );
